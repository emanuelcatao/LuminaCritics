...
router.route("/comentario/all/:movie_id").get(commentController.retornarComentariosPorFilmeAll)
...
router.route("/avaliar/item/:movie_id/avaliacoes").get(ratingController.buscarAvalicoesAll)
